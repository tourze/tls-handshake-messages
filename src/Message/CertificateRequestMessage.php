 ...
 * 证书请求消息
 */
final class CertificateRequestMessage extends AbstractHandshakeMessage
{
    /**
     * 消息类型
     */
     ...
     */
    public function setSignatureAlgorithms(array $signatureAlgorithms): void
    {
     ...
     */
    public function setCertificateAuthorities(array $certificateAuthorities): void
    {
